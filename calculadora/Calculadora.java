 ...
 *
 * <p>O usuário fornece operandos e uma operação matemática como soma, subtração,
 * multiplicação ou divisão. O método principal da classe seleciona a operação
 * desejada com base no operador informado pelo usuário.</p>
 *
 * <p>Esse projeto é utilizado para demonstrar:</p>
 *
 * <ul>
 *   <li>Técnicas de revisão estática (caixa branca)</li>
 *   <li>Testes de revisão (caixa branca)</li>
 *   <li>Aplicação de refatoração em códigos Java</li>
 *   <li>Documentação com JavaDoc</li>
 * </ul>
 *
 * <p>A refatoração, ao reduzir níveis de classe sem alteração da função,
 * sem efeitos colaterais, permite maior legibilidade e facilitando testes unitários.</p>
 *
 * @author Natan Silva
 * @version 1.0
 */
